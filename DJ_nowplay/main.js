function click_btn(num) {
	...
	let post_text = "No."+num+"%0A"+song_name+"%0A"+singer+"%0A%0A"+other_text;
	let url = "https://twitter.com/share?text="+post_text+"%0A&url=%0A&hashtags="+hash_tag1_text+"%0A&hashtags="+hash_tag2_text;
